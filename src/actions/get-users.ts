...
import { demoReadonlyAdminActionClient } from '@/lib/safe-action';
import {
  and,
  asc,
  count as countFn,
...
export const getUsersAction = demoReadonlyAdminActionClient
      ...
      if (search) {
        ...
        conditions.push(
          or(
            ...
            sql`lower(${user.customerId}) LIKE ${searchPattern}`
          )
        );
      }
